...
- 성학대는 어린 시절부터 지속적으로 피해를 당하는 경우가 많기 때문에, 자신의 의사를 표현할 수 있는 청소년기 때 비교적 늦은 시기에 신고 접수가 이루어짐
```
![Alt text](image-5.png)
```
- 4가지 유형 중 3가지 유형 신체학대, 정서학대, 방임은 압도적인 수치로 부모로부터 발생한 피해, 즉 아동학대의 주된 가해자는 부모임을 알 수 있다.
